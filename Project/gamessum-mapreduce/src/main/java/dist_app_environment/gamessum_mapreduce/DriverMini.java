...
public class DriverMini {
    ...
    private final static Path DFS_INPUT_DIR = new Path("gamessum/input");
    private final static Path DFS_OUTPUT_DIR = new Path("gamessum/output");
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (otherArgs.length < 2) {
            System.err.println("Usage: gamessum <local_in> [<local_in>...] <local_out>");
            System.exit(2);
        }
        // cluster start
        ...
        // job
        final Job job = GamesSum.createJob(conf);
